...
export function filterPillButtonClassNames(active: boolean): string {
  return clsx(
    "shrink-0 select-none whitespace-nowrap rounded-full px-4 py-2 text-[17px] font-medium transition-all focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#0C2B59]/15 active:scale-[0.98]",
    active
