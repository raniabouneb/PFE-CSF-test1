...
import { isSiteMailError, sendSiteMail, solutionContactRecipients } from "@/lib/email/send-site-mail"
...
export async function POST(req: Request) {
  try {
    ...
    try {
      await sendSiteMail({ subject, text, html, replyTo: email, to: solutionContactRecipients(), attachments })
    } catch (e) {
