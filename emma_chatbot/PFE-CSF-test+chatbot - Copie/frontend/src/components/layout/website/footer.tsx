...
const MAP_ADDRESS_LINE_1 = "122 rue Fethi Zouhir Ennekhilet — Ariana"
...
const CSF_EMAIL = "formation@csfgroupe.tn"
const CSF_EMAIL_HREF = `https://mail.google.com/mail/?view=cm&fs=1&to=${encodeURIComponent(CSF_EMAIL)}`
...
const contactBlocks = [
  {
    ...
    href: MAP_SHARE_URL,
    external: true,
    ariaLabel: "Ouvrir l'adresse CSF dans Google Maps",
  },
  {
    key: "phone",
    heading: "Téléphone",
  ...
  },
  {
    ...
    href: CSF_EMAIL_HREF,
    external: true,
    ariaLabel: `Ouvrir Gmail pour envoyer un e-mail à ${CSF_EMAIL}`,
  },
] as const
...
/** Liens réseaux — mettre à jour les URL YouTube / TikTok officielles CSF si besoin. */
const socialLinks = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/csf-opportunit%C3%A9s-a0baa73a0/",
    Icon: LinkedInGlyph,
  },
  {
    label: "Facebook",
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@CentreCSF",
    Icon: YouTubeGlyph,
  },
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@centre.csf",
    Icon: TikTokGlyph,
  },
] as const
