 ...
 * Ces constantes servent de fallback ; les données réelles viennent de /api/admin/backend/dashboard/stats.
 */

export type KpiKey = "inscrits" | "certifications" | "visitesWeb" | "nouveauxComptes" | "groupes"

export type AdminDashboardStats = {
  kpis: typeof KPI_DEFINITIONS_MAIN
  topVisited: typeof TOP_VISITED
  topEnrolled: typeof TOP_ENROLLED
