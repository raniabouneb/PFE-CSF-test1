...
import { useSetAuthUser, type AuthUser } from "@/components/platform/auth/auth-user-context"
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    try {
      ...
      try {
        ...
        if (me.ok) {
          const u = (await me.json()) as ProfileUser
      ...
      if (!isStaffRole(role)) {
        void prefetchLearnerPlatformQueries(queryClient)
      }
