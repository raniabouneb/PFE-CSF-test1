      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-[1400px] px-4 pb-8 pt-24 mt-10 lg:px-6">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div className="flex w-full max-w-[550px] shrink-0 items-center gap-2">
              <div className="flex h-[55px] min-w-0 flex-1 items-center gap-2 rounded-full border border-white/15 bg-white/15 px-4 py-2.5 backdrop-blur-sm">
                <input
                  type="search"
