    ...
    <>
      ...
      <div
        className={cn(
          ...
          showOfferBadges
            ? "bottom-0 left-0 right-0 top-0 p-4"
            : "inset-x-4 inset-y-4 flex flex-col justify-center gap-3 px-4 py-6 sm:gap-3 sm:px-5 sm:py-7",
        )}
      >
        {showOfferBadges ? (
          <div className="mb-3 mt-4 ml-4 flex flex-wrap items-center gap-2">
        ...
        <h3
          className={cn(
            "text-balance break-words text-base font-bold text-white md:text-[22px] ml-4",
            showOfferBadges ? "mb-1" : "mb-0",
          )}
        >
          {title}
        </h3>
        <p className="text-sm ml-4 leading-relaxed text-white/90 break-words md:text-[17px]">
